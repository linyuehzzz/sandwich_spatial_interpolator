/********************************************************************************
** Form generated from reading UI file 'sshlayermanager.ui'
**
...
#ifndef UI_SSHLAYERMANAGER_H
#define UI_SSHLAYERMANAGER_H
...
public:
    ...
    {
        SSHLayerManager->setWindowTitle(QApplication::translate("SSHLayerManager", "SSH Layer Manager", 0));
        Load->setText(QApplication::translate("SSHLayerManager", "Load", 0));
        Cancel->setText(QApplication::translate("SSHLayerManager", "Cancel", 0));
        groupBox->setTitle(QApplication::translate("SSHLayerManager", "SSH layer settings", 0));
