...
`Sandwich` is an R package for spatial interpolation based on the [spatial stratified heterogeneity (SSH)](http://www.geodetector.cn/) theory, which:
...
```
A manual of the `Sandwich` package can be found [here](https://github.com/linyuehzzz/sandwich_spatial_interpolator/blob/master/r/Sandwich_1.0.0.pdf), which introduces all the available functions in this package.
