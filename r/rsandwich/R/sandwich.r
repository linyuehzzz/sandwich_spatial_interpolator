...
#'
#' @usage \code{sandwich(sampling.lyr, ssh.lyr, reporting.lyr, sampling.attr)}
#'
#' @param sampling.lyr POINT \code{sf} object used as the sampling layer. It should contain an attribute that is to be interpolated.
#' @param ssh.lyr POLYGON \code{sf} object used as the SSH layer.
#' @param reporting.lyr POLYGON \code{sf} object used as the reporting layer.
