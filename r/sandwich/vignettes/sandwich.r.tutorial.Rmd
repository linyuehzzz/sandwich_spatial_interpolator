...
The first case study interpolates the human population density in Heshun County, China based on a synthetic sample of 312 units. A zonation consists of 5 spatially contiguous strata is used as a candidate SSH layer. The administrative division of 10 towns in Heshun County is used as the reporting layer. The sampling, SSH, and reporting layers are all in the shapefile format.
